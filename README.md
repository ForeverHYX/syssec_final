...
| Combined benchmark Micro F1 | HardenInspector 0.938；APKiD 0.348；Androguard DEX 0.552；ZIP Strings 0.746 |
| 外部现成 APK 语料 | 已纳入评分；单独统计中四个工具仍为 12/12 coverage |
| 外部语料 HardenInspector 分布 | Any 11/12；packer=4；obfuscation=7；environment=5；native=3；F-Droid 样本无 finding |

...
| 现场可视化展示 | `make demo-web` 启动中文本地 Web demo，首屏展示展品导览、证据链、数据集说明、APK 拆解图、34 个评分 APK、69 个测试和 HardenInspector Micro F1；页面可扫描 curated APK 样本、上传本地 APK，并展示 evidence 与 benchmark 指标 |

...
验证结果：当前环境中 43 个测试通过，CLI 可用；四个默认 benchmark 工具均为 29/29 combined scoring coverage，单独外部统计为 12/12 coverage。`make demo-web` 可启动本地网页展示，默认监听 `http://127.0.0.1:8000/`。
